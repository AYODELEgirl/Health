...
function MorePublication({ setMorePublication }) {
  ...
  const PPublicationdata = [
    {
      ...
      image: publicone,
      text: "A medical device is defined as 'An article, in- strument, apparatus or machine that is used in the prevention.",
      text2:
        "A medical device is defined as 'An article, in- strument, apparatus or machine that is used in the prevention, diagnosis or treatment of illness or disease, or for detecting, measuring, restoring, correcting or modifying the structure or function of the body for some health purpose. .",
      link: "/ReadMore",
    ...
    },
    {
      ...
      image: public2,
      text: "Every day, about 1.6 million people around the world become sick from eating unsafe food, many of them small children.",
      text2:
    ...
    },
    {
      ...
      image: public4,
      text: "Sanitary pad prices have increased by 40-75%, forcing many to switch to cheaper, less preferred products.",
      text2:
    ...
    },
    {
      ...
      link: "/ReadMore",
      link2: "https://drive.google.com/file/d/1VquVf1ZSt8uM_HBaliK3oDak1NG5wrKd/view?usp=drive_link",
    ...
    },
    {
      ...
      image: public7,
      text: "Hypertension is a leading cause of death, globally.",
      text2:
    ...
    },
    {
      ...
      link: "/ReadMore",
      link2 : "https://drive.google.com/file/d/1s-7sgC8OyHJKLlX2WOm1lkHDPcrIK7ok/view?usp=drive_link",
      type: "Whitepapers",
    },
    {
      id: "8",
      ...
      link: "/ReadMore",
      link2: "https://drive.google.com/file/d/13heC12q3fg80VCu82WI1Uo7W2zxxz6I8/view?usp=drive_link",
      type: "Whitepapers",
    },
    {
      id: "9",
      ...
      link: "/ReadMore",
      link2: "https://drive.google.com/file/d/1VFfOwIIe1q1IXrfh3qrK3czX98b23uw6/view?usp=drive_link",
      type: "Review Articles",
    },
    {
      id: "10",
      ...
      link: "/ReadMore",
      link2: "https://drive.google.com/file/d/1cyEjWpntZjx9Xthy-LhmfTFDKmGivxvQ/view?usp=drive_link",
      type: "Whitepapers",
    },
    {
      id: "11",
      ...
      link: "/ReadMore",
      link2 : "https://drive.google.com/file/d/1oiy-p2nmrQBIvL9hlb-QvApHj_53gJfm/view?usp=drive_link",
      type: "Whitepapers",
    },
    {
      id: "12",
    ...
    },
    {
      ...
      link: "/ReadMore",
      link2: "https://drive.google.com/file/d/1czAuAlnVd_XFGJBYzUq_eGY3FJghJ1VE/view?usp=drive_link",
      type: "Infographics",
    },
    {
      id: "14",
      ...
      link: "/ReadMore",
      link2: "https://drive.google.com/file/d/1V4Yh_zMpCt74RIh-VNOelS9WYAtQZxGG/view?usp=drive_link",
      type: "Case Studies",
    },
    {
      id: "15",
      ...
      image: publicone,
      text: "Across the African continent, a paradigm shift is underway, driven by a growing recognition that sustainable progress ",
      text2:
      ...
      link: "/ReadMore",
      link2: "https://drive.google.com/file/d/1vd7cbQnTwAXuk1wGGWKNeXrRDnZbzxf9/view?usp=drive_link",
      type: "Whitepapers",
    },
    {
      id: "16",
      ...
      link: "/ReadMore",
      link2 : "https://drive.google.com/file/d/1526R3d5XN6PcXQqzKgbFelHJ4O4Dj2Ax/view?usp=drive_link",
      type: "Case studies",
    },
  ];
  ...
  const NavLink = [
    ...
    { name: "Market Reports", click: handleFilter, vaJlue: "Market Reports" },
